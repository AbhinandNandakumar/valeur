    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col p-4 md:p-6 lg:p-8">
      ...
      <header className="w-full flex justify-between items-center mb-8 p-4 bg-gray-800 rounded-lg shadow-lg">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="font-bold text-xl text-white">VALEUR</h1>
      ...
      <div className="w-full max-w-3xl mx-auto mb-8">
        <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-2">
          <input
            ...
            className="flex-1 px-4 py-3 text-white bg-gray-800 border border-gray-700 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 transition-all"
          />
          <button
            type="submit"
            disabled={isLoading}
            className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center md:w-auto"
          >
            {isLoading ? (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
        ...
        <div className="bg-gray-800 rounded-lg p-4 shadow-lg">
          ...
          <img className="mt-1" src="/amazon.png" alt="Description" width="100" height="100" />
        ...
        <div className="bg-gray-800 rounded-lg p-4 shadow-lg">
          <div className="flex items-center mb-4">
          <img src="/snap.png" alt="Description" width="120" height="120" />
        ...
        <div className="bg-gray-800 rounded-lg p-4 shadow-lg">
          <div className="flex items-center mb-4">
          <img src="/croma.png" alt="Description" width="100" height="100" />
        ...
        <div className="bg-gray-800 rounded-lg p-4 shadow-lg">
          <div className="flex items-center mb-4">
          <img src="/flip.png" alt="Description" width="130" height="130" />
          </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    {product.product_url && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-yellow-400 hover:bg-yellow-600 text-white text-center py-2 rounded-md mt-2 transition-colors"
                      >
                        View Product
                      </a>
                    )}
